...
## pull file redirected from https://www.curseforge.com/minecraft/modpacks/skyfactory-4/download/3012800/file 
 wget -c https://qpkg.app/TheLostEraModpack-1.6.2.zip -O TheLostEraModpack-1.6.2.zip && \
 unzip TheLostEraModpack-1.6.2.zip -d /tmp/lost-era && \
...
ENV MOTD "A Minecraft (Lost Era 1.6.2) Server Powered by Noodlez"
ENV LEVEL world
